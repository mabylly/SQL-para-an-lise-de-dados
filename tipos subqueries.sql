...
-- a data da visita f2.visit_page_date 
-- a data da visita atual f.visit_page_date
-- subqueries com select demoram muito, pq é como se tivesse fazendo uma querie a cada iteracao
select 
	f.visit_id,
	f.visit_page_date,
	s.store_name,
